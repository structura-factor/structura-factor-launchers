...
$INSTALL_URL = "https://cdn.jsdelivr.net/gh/structura-factor/structura-factor-launchers@0ae081ba986895116f2c8598f567634b58282693/Install-STRUCTURA-FACTOR.ps1"
