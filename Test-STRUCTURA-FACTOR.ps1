...
$INSTALL_URL = "https://cdn.jsdelivr.net/gh/structura-factor/structura-factor-launchers@8362356e2ec0b759e2ac75ca144287653dd31768/Install-STRUCTURA-FACTOR.ps1"
