...
$INSTALL_URL = "https://cdn.jsdelivr.net/gh/structura-factor/structura-factor-launchers@d48c1eb6f92a23b5517603e524cc8ce8ccf43e55/Install-STRUCTURA-FACTOR.ps1"
