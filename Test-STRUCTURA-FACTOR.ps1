...
$INSTALL_URL = "https://cdn.jsdelivr.net/gh/structura-factor/structura-factor-launchers@7bcd060d39346a854ecb797583ccb6ff221ff82f/Install-STRUCTURA-FACTOR.ps1"
