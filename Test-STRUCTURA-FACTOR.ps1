...
$INSTALL_URL = "https://cdn.jsdelivr.net/gh/structura-factor/structura-factor-launchers@2a7e4bcdc4c06de82f554db56dd139662bfd1cd1/Install-STRUCTURA-FACTOR.ps1"
