...
$INSTALL_URL = "https://cdn.jsdelivr.net/gh/structura-factor/structura-factor-launchers@a3f4ed470dca6d8b5a33264d9c41b0f1e9a9316a/Install-STRUCTURA-FACTOR.ps1"
