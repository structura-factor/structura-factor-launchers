...
$INSTALL_URL = "https://cdn.jsdelivr.net/gh/structura-factor/structura-factor-launchers@356dee7c519ac022bdef880ab969620aeece7b26/Install-STRUCTURA-FACTOR.ps1"
