...
$INSTALL_URL = "https://cdn.jsdelivr.net/gh/structura-factor/structura-factor-launchers@948a0ab7bad95cebe3bcde4addf105a7ec703070/Install-STRUCTURA-FACTOR.ps1"
