...
# dashboard.basic_auth w ~/.hermes/config.yaml (username + password_hash).
        ...
        #
        # Zasada: w here-stringu trzymaj TYLKO tresc pliku. Zadnych obliczen,
        # zadnych zagniezdzonych here-stringow, zadnych wywolan systemctl.
        # ==================================================================

        # Oblicz dane logowania do dashboardu (poza plikiem unita!)
        ...
        # Drop-in z auth (osobny here-string, tez zamkniety od razu)
